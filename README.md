...
Skill de Alexa que actúa como asistente inteligente con dos modos de respuesta:
internet en tiempo real (Brave) o conocimiento general (Gemini).
...
GEMINI_API_KEY_1=tu_clave
GEMINI_API_KEY_2=tu_clave
GEMINI_API_KEY_3=tu_clave
GEMINI_API_KEY_4=tu_clave
BRAVE_API_KEY_1=tu_clave
BRAVE_API_KEY_2=tu_clave
DYNAMODB_TABLE=laia-historial
...
1. Crea una nueva skill en español
2. Ve a **JSON Editor**
3. Pega el contenido de `skill/interactionModel.json`
4. Haz clic en **Save Model** → **Build Model**
...
Usuario: "Alexa, abre [nombre de tu skill]"
Alexa: "Hola, soy tu asistente. ¿Vas a hacer preguntas sobre información actual?"
Usuario: "Sí" → activa modo Brave (internet)
"No" → activa modo Gemini (conocimiento general)

Usuario: "Dime quién ganó el último Gran Premio de Fórmula 1"
Usuario: "Explícame cómo funciona un motor de hidrógeno"
Usuario: "Nada más" / "Adiós" → cierra la sesión
